            ...
            <div class="headerContainer">
                ...
                <div class="snb">
                    ...
                    <% } else { %>
                        ...
                        <button class="login-btn" onclick="location.href='./sub01.jsp'"> 로그인 </button>
                        
                        <!-- 회원가입 버튼을 보여주며, 클릭 시 회원가입 페이지로 이동 -->
                        <button class="signup-btn" onclick="location.href='./sub03.jsp'"> 회원가입 </button>
                    <% } %>
                </div>
        ...
        <script>
            ...
            reviews.forEach(review => {
                ...
                function checkLogin() {
                    ...
                    // 호텔 예약 페이지(sub05.jsp)로 이동함.
                    if (loginStatus === 'loggedIn') {
                        window.location.href = './sub05.jsp';
                    } else {
