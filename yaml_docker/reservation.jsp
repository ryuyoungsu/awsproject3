...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        // 데이터베이스 연결 정보
        String dbURL = "jdbc:mariadb://localhost:3306/yas?useUnicode=true&characterEncoding=UTF-8";
        ...
        try {
            ...
            if (result > 0) {
                out.println("<script>alert('예약이 완료되었습니다.'); location.href='dog_site.jsp';</script>");
            } else {
        ...
        <header>
            <div class="headerContainer">
                ...
                <ul class="gnb">
                    ...
                    <li><a href="./sub05.jsp">HOTEL</a></li>
                    <li><a href="#none">DOG TRAINING</a></li>
                    <li><a href="#none">SPA & BEAUTY</a></li>
                    <li><a href="./sub02.jsp">CONTACT</a></li>
                </ul>

                <ul class="snb">
                    <li>
                        <a href="./sub01.jsp" class="enter"></a>
                    </li>
