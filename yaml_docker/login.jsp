...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("POST")) {
        ...
        try {
            ...
            String dbURL = "jdbc:mariadb://localhost:3306/yas";
            ...
            if (rs.next()) {
                ...
                // 로그인 성공 시 메인 페이지로 이동
                response.sendRedirect("dog_site.jsp");
                return;
            } else {
    ...
    <header>
        <div class="headerContainer">
            ...
            <ul class="gnb">
                ...
                <li><a href="./sub05.jsp">HOTEL</a></li> 350
                <li><a href="#none">DOG TRAINING</a></li>
                <li><a href="#none">SPA & BEAUTY</a></li>
                <li><a href="./sub02.jsp">CONTACT</a></li> 353
            </ul>
            ...
            <div class="max-width460px">
                ...
                <form method="post">
                    ...
                    <div class="logBotton">
                        ...
                        <button type="button" onclick="location.href='./sub03.jsp';">회원가입</button>
                    </div>
                </form>
            </div>
        </div>
